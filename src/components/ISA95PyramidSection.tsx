...
interface ISA95PyramidSectionProps {
  onComplete: () => void;
}

const ISA95PyramidSection: React.FC<ISA95PyramidSectionProps> = ({ onComplete }) => {
  const [selectedLevel, setSelectedLevel] = useState(4);
  const [showDataFlow, setShowDataFlow] = useState(false);
  const [animationRunning, setAnimationRunning] = useState(true);
  const [currentScenario, setCurrentScenario] = useState('normal');

  // ISA-95 Level Definitions for Maruti Suzuki
  const levels = {
    4: {
      ...
      systems: [
        {
          ...
          examples: [
            ...
            "Raw material procurement (steel, aluminum, plastics)",
      ...
      systems: [
        {
          ...
          examples: [
            "Work order management for vehicle production",
        ...
        },
        {
          ...
          examples: [
            "Raw material tracking (steel coils, engines, transmissions)",
      ...
      systems: [
        {
          ...
          examples: [
            ...
            "Recipe management for different vehicle variants"
          ]
        },
        {
  ...
  const PyramidLevel = ({ level, levelData, isSelected, onClick }: any) => {
          ...
          {isSelected && (
            <div className="mt-4 space-y-2">
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-2">
                {levelData.kpis.map((kpi: any, index: number) => (
  ...
  const DetailPanel = ({ levelData }: any) => (
    <div className="bg-white rounded-lg shadow-lg p-6 space-y-6">
      ...
      <div>
        ...
        <div className="space-y-4">
          {levelData.systems.map((system: any, index: number) => (
            <div key={index} className="border rounded-lg p-4">
              ...
              <ul className="space-y-1">
                {system.examples.map((example: string, idx: number) => (
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div className="bg-blue-50 rounded-lg p-4">
          ...
          <ul className="space-y-1">
            {levelData.dataFlow.receives.map((item: string, index: number) => (
        ...
        <div className="bg-green-50 rounded-lg p-4">
          ...
          <ul className="space-y-1">
            {levelData.dataFlow.sends.map((item: string, index: number) => (
  ...
  const ScenarioPanel = () => (
    <div className="bg-white rounded-lg shadow-lg p-6">
      ...
      <div className="mt-6 p-4 bg-yellow-50 rounded-lg">
        ...
        <p className="text-sm text-yellow-700">{scenarios[currentScenario as keyof typeof scenarios].description}</p>
  ...
  return (
    <div className="space-y-8">
      ...
      <div className="text-center bg-white rounded-xl shadow-lg p-6">
        ...
        <h1 className="text-3xl font-bold text-gray-900 mb-2">ISA-95 Automation Pyramid</h1>
        <p className="text-gray-600">Maruti Suzuki Automotive Manufacturing Integration Architecture</p>
            ...
            <div className="space-y-4">
              {[4, 3, 2, 1, 0].map(level => (
                <div key={level} className="flex justify-center">
                  <PyramidLevel
                    level={level}
                    levelData={levels[level as keyof typeof levels]}
      ...
      <div className="mt-8">
        <DetailPanel levelData={levels[selectedLevel as keyof typeof levels]} />
      </div>

      {/* Manufacturing Process Context */}
      <div className="mt-8 bg-white rounded-lg shadow-lg p-6">
        <h3 className="text-xl font-semibold text-gray-800 mb-4">Automotive Manufacturing Process Context</h3>
        <div className="grid grid-cols-1 md:grid-cols-5 gap-4">
          {[
            { stage: "PVC Extrusion", temp: "185°C", level: "0-2" },
            { stage: "Body Welding", temp: "1540°C", level: "0-2" },
      ...
      <div className="text-center bg-green-50 rounded-xl p-6">
        <h3 className="text-lg font-semibold text-green-800 mb-2">Excellent! You understand the ISA-95 automation pyramid</h3>
        <p className="text-green-700 mb-4">Now let's explore some live technology demonstrations</p>
        <button
          onClick={onComplete}
...
export default ISA95PyramidSection;